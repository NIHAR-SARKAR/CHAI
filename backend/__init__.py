...
- AI decision engine with thin-brain, thick-loop architecture
- Extensible plugin system for pentest tools
- Firejail sandboxing with cgroups
- SQLite-only database (no external dependencies)
